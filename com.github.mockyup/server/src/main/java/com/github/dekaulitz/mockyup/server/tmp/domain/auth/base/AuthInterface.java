package com.github.dekaulitz.mockyup.server.tmp.domain.auth.base;

import com.github.dekaulitz.mockyup.server.tmp.domain.auth.vmodels.DtoAuthProfileVmodel;
...
public interface AuthInterface {
   ...
   */
  DtoAuthProfileVmodel generateAccessToken(String username, String password)
   ...
   * @throws UnsupportedEncodingException when something bad happen when generate token
   */
  DtoAuthProfileVmodel refreshingToken(String token)
      throws UnathorizedAccess, UnsupportedEncodingException;
}
