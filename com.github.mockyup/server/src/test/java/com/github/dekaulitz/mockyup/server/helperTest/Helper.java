package com.github.dekaulitz.mockyup.server.helperTest;
...
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.CreatorMockVmodel;
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.DtoMockUserLookupVmodel;
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.DtoMockupDetailCurrentAccessVmodel;
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.DtoMockupDetailUpdatedByVmodel;
...
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.UserDetailMocks;
import com.github.dekaulitz.mockyup.server.domain.mocks.vmodels.UserMockVmodel;
...
public class Helper {
  ...
  public static UserEntities getUserEntities() {
    ...
    return UserEntities.builder()
        .accessList(accessList)
        .password(HashingHelper.hashing(DEFAULT_PASSWORD))
        .username("default")
        .build();
  }
