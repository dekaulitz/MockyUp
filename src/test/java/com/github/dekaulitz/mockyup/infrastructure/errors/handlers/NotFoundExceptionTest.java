...
class NotFoundExceptionTest {
    ...
    void getErrorVmodel() {
        try {
            ...
            Assert.isTrue(e.getErrorVmodel().getErrorCode().equals(ResponseCode.USER_ALREADY_EXIST.getErrorCode()), "error code not expected");
            Assert.isTrue(e.getErrorVmodel().getHttpCode().value() == ResponseCode.USER_ALREADY_EXIST.getHttpCode().value(), "http code not expected");
