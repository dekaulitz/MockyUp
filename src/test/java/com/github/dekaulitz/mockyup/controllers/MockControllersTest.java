...
class MockControllersTest extends BaseTest {
    ...
    void mockingPath() throws IOException {
        ...
        ResponseEntity<ResponseVmodel> response1 = this.restTemplate
                .exchange(baseUrl + "/mocks/mocking/x?path=asdasd", HttpMethod.GET, request1, ResponseVmodel.class);
        isTrue(response1.getStatusCode().value() == ResponseCode.MOCKUP_NOT_FOUND.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response1.getBody().getResponseCode().equals(ResponseCode.MOCKUP_NOT_FOUND.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
    ...
    void getCurrentAccess() throws IOException {
        ...
        ResponseEntity<ResponseVmodel> response2 = this.restTemplate
                .exchange(baseUrl + "/mocks/x/detailWithAccess", HttpMethod.GET, request1, ResponseVmodel.class);
        isTrue(response2.getStatusCode() == ResponseCode.INVALID_ACCESS_PERMISSION.getHttpCode(), HTTPCODE_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseMessage().equals(ResponseCode.INVALID_ACCESS_PERMISSION.getErrorMessage()), RESPONSE_BODY_NOT_EXPECTED);
    }
    ...
    void addUserAccess() throws IOException {
        ...
        isTrue(response2.getStatusCode().value() == ResponseCode.MOCKUP_NOT_FOUND.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseCode().equals(ResponseCode.MOCKUP_NOT_FOUND.getErrorCode()), HTTPCODE_NOT_EXPECTED);
        ...
        response2 = this.restTemplate
                .exchange(baseUrl + "/mocks/x/addUser", HttpMethod.PUT, request1, ResponseVmodel.class);
        isTrue(response2.getStatusCode().value() == ResponseCode.INVALID_ACCESS_PERMISSION.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
    ...
    void removeUserAccessOnMock() throws IOException {
        ...
        isTrue(response2.getStatusCode().value() == ResponseCode.MOCKUP_NOT_FOUND.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseCode().equals(ResponseCode.MOCKUP_NOT_FOUND.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
        ...
        response2 = this.restTemplate
                .exchange(baseUrl + "/mocks/x/remove/x", HttpMethod.DELETE, request1, ResponseVmodel.class);
        isTrue(response2.getStatusCode().value() == ResponseCode.INVALID_ACCESS_PERMISSION.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseCode().equals(ResponseCode.INVALID_ACCESS_PERMISSION.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
    ...
    void storeMocksEntity() throws IOException {
        ...
        isTrue(response2.getStatusCode().value() == ResponseCode.INVALID_MOCKUP_STRUCTURE.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseCode().equals(ResponseCode.INVALID_MOCKUP_STRUCTURE.getErrorCode()), HTTPCODE_NOT_EXPECTED);
    }
    ...
    void deleteByMockId() throws IOException {
        //given
        when(this.mockRepository.findById(any())).thenReturn(java.util.Optional.of(Helper.getMockEntities()));
        //when user do request
        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "Bearer " + Helper.generateToken(givenId, 10, 10));
        HttpEntity<HttpHeaders> request1 = new HttpEntity<>(headers);
    ...
    void getMocksPagination() throws IOException {
        ...
        //given
        when(this.mockRepository.paging(any(), any(), any())).thenThrow(new RuntimeException("something bad"));
        //when user do request
        headers = new HttpHeaders();
        headers.set("Authorization", "Bearer " + Helper.generateToken(givenId, 10, 10));
        request1 = new HttpEntity<>(headers);
        ...
        isTrue(response2.getStatusCode().value() == ResponseCode.GLOBAL_ERROR_MESSAGE.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(!response2.getBody().getRequestId().isEmpty(), RESPONSE_BODY_NOT_EXPECTED);
        isTrue(response2.getBody().getResponseCode().equals(ResponseCode.GLOBAL_ERROR_MESSAGE.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
    ...
    void getMockingPathNotFound() throws IOException {
        ...
        ResponseEntity<String> responseEntity = this.restTemplate
                .exchange(baseUrl + "/mocks/mocking/id?path=/boosks?query=title:empty&sort=published:desc", HttpMethod.GET, headersHttpEntity, String.class);
