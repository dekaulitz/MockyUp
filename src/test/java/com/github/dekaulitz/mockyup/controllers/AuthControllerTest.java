...
class AuthControllerTest extends BaseTest {
    ...
    void login() {
        ...
        isTrue(response1.getStatusCodeValue() == ResponseCode.INVALID_USERNAME_OR_PASSWORD.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response1.getBody().getResponseCode().equals(ResponseCode.INVALID_USERNAME_OR_PASSWORD.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
        ...
        ResponseEntity<ResponseVmodel> response3 = this.restTemplate
                .postForEntity(baseUrl + "/mocks/login", request, ResponseVmodel.class);
        isTrue(response3.getStatusCodeValue() == ResponseCode.INVALID_USERNAME_OR_PASSWORD.getHttpCode().value(), HTTPCODE_NOT_EXPECTED);
        isTrue(response3.getBody().getResponseCode().equals(ResponseCode.INVALID_USERNAME_OR_PASSWORD.getErrorCode()), RESPONSE_BODY_NOT_EXPECTED);
    ...
    void refreshToken() throws UnsupportedEncodingException {
        ...
        ResponseEntity<DtoAuthProfileVmodel> response1 = this.restTemplate
                .exchange(baseUrl + "/mocks/auth/refresh", HttpMethod.GET, request1, DtoAuthProfileVmodel.class);
        ...
        isTrue(response2.getStatusCode() == ResponseCode.TOKEN_INVALID.getHttpCode(), HTTPCODE_NOT_EXPECTED);
//        isTrue(response2.getBody().getResponseMessage().equals(ResponseCode.TOKEN_INVALID.getErrorMessage()), RESPONSE_BODY_NOT_EXPECTED);
        ...
        isTrue(response3.getStatusCode() == ResponseCode.TOKEN_EXPIRED.getHttpCode(), HTTPCODE_NOT_EXPECTED);
        isTrue(response3.getBody().getResponseMessage().equals(ResponseCode.TOKEN_EXPIRED.getErrorMessage()), RESPONSE_BODY_NOT_EXPECTED);
        ...
        response3 = this.restTemplate
                .exchange(baseUrl + "/mocks/auth/refresh", HttpMethod.GET, request3, ResponseVmodel.class);
        isTrue(response3.getStatusCode() == ResponseCode.TOKEN_INVALID.getHttpCode(), HTTPCODE_NOT_EXPECTED);
        isTrue(response3.getBody().getResponseMessage().equals(ResponseCode.TOKEN_INVALID.getErrorMessage()), RESPONSE_BODY_NOT_EXPECTED);
        ...
        isTrue(response4.getStatusCode() == ResponseCode.TOKEN_INVALID.getHttpCode(), HTTPCODE_NOT_EXPECTED);
        isTrue(response4.getBody().getResponseMessage().equals(ResponseCode.TOKEN_INVALID.getErrorMessage()), RESPONSE_BODY_NOT_EXPECTED);
    }
}
