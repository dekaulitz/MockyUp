...
public class MockModel extends BaseMockModel implements MockInterface {
   ...
   */
  @Override
  public MockEntities getById(String id, AuthenticationProfileModel authenticationProfileModel)
   ...
   */
  @Override
  public MockEntities save(MockVmodel view, AuthenticationProfileModel authenticationProfileModel)
   ...
   * @param authenticationProfileModel {@link AuthenticationProfileModel} auth profile for
   ...
   */
  @Override
  public void deleteById(String id, AuthenticationProfileModel authenticationProfileModel)
      throws NotFoundException {
    Optional<MockEntities> mockEntities = this.mockRepository.findById(id);
    if (!mockEntities.isPresent()) {
      throw new NotFoundException(ResponseCode.MOCKUP_NOT_FOUND);
   ...
   * @param authenticationProfileModel {@link AuthenticationProfileModel} auth profile for getting
  ...
  /**
   * @param id                         {@link String}id from mock collection
   * @param authenticationProfileModel {@link AuthenticationProfileModel} get detail from auth
   *                                   profile
   ...
   * @param authenticationProfileModel {@link AuthenticationProfileModel} current auth profile
   *                                   access
