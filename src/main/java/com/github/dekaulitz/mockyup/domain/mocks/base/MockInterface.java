...
public interface MockInterface {
   ...
   */
  MockEntities getById(String id, AuthenticationProfileModel authenticationProfileModel)
   ...
   */
  MockEntities save(MockVmodel view, AuthenticationProfileModel authenticationProfileModel)
   ...
   */
  void deleteById(String id, AuthenticationProfileModel authenticationProfileModel)
      throws NotFoundException;
